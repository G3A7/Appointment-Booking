          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col justify-end gap-2 ">
                ...
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-red-600  hover:text-white transition-all duration-300">Cancel appointmenst</button>
              </div>
            </div>
          );
        })}
